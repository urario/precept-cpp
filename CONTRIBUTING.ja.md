...
Precept は [Apache License 2.0](LICENSE) で提供されます。貢献物も同じ条件で提供されます。ライセンス
第 5 条により、取り込みを意図して提出したものはそのライセンスの下に置かれ、本プロジェクトはその上に独自の
CLA や DCO を課していません。ライセンス選択の理由は
